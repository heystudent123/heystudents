      ...
      <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="mt-1 text-gray-600">info@duflatfinder.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="mt-1 text-gray-600">123 University Road, North Campus, Delhi - 110007</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    <h3 className="text-lg font-medium text-primary">Office Hours</h3>
            ...
            <div className="bg-white shadow-md rounded-lg p-8">
              ...
              <form onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="PG Listing">PG Listing</option>
                ...
                <div>
                  <button
                    type="submit"
                    className="w-full bg-accent hover:bg-accent/90 text-white py-3 px-4 rounded-md font-medium transition-colors duration-300"
                  >
                    Send Message
                  </button>
                </div>
        ...
        <div className="mt-16">
          ...
          <div className="h-96 rounded-lg overflow-hidden">
            ...
            <img 
              src="https://images.unsplash.com/photo-1577615902234-43b5c9da8286?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1000&q=80" 
              alt="Map" 
